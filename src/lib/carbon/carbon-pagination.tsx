...
import { IconButton, Select, SelectItem, usePrefix, TextInput, NumberInput } from '@carbon/react';
...
const CarbonPagination = React.forwardRef(function Pagination(
  {
  ...
  function handlePageInputChange(event, { value } = {}) {
    const page = Number(event.target.value || value);
