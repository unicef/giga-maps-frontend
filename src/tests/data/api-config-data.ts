export default {
  ...
  "DATA_SOURCE_TYPE_CHOICES": {
    ...
    "DAILY_CHECK_APP": "Daily Check App",
    "QOS": "QoS"
  },
  ...
  "LAYER_CATEGORY_CHOICES": {
    "CONNECTIVITY": "Connectivity Layer Category",
    "COVERAGE": "Coverage Layer Category"
  },
  ...
  "PERMISSION_CHOICES": {
    "can_access_users_tab": "Can Access User Management Tab",
