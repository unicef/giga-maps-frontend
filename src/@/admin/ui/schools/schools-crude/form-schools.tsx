...
import { BottomButtonWrapper, InputBoxWrapper, InputContainer, InputLabel, LastWeekStatusWrapper, RowContainer, SchoolFieldsWrapper, SchoolFormScroll, WeeklyStatslinkSchool } from "../../styles/admin-styles"
        ...
        <RowContainer>
          <InputContainer>
            ...
            <WeeklyStatslinkSchool>
              <Link href={`/admin/schools/?tab=1&schoolId=${formSchool?.id}`} target="_blank">
                Here
              </Link>
