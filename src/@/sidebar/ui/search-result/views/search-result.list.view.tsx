...
import { DEFAULT_ENTITY_REGISTRY, EntityType } from "~/@/entities";
      ...
      >
        <LeftItem $fullWidth>
          ...
          {item.type === SEARCH_DATA_TYPE.SCHOOL && <span className="type-name">
            ...
            {t(item?.entityTypetag === EntityType.HEALTH ? 'health-centers_one' : DEFAULT_ENTITY_REGISTRY[item.entityTypetag].slug)} <span className="light">{' '}{t('in')}{' '}</span>
