...
const breadcrumbWrapperClassName =
  'mt-2! flex! h-12! w-full! items-center! justify-between! border-b! border-border! bg-background! px-4! py-[0.88rem]! max-md:fixed! max-md:top-10! max-md:z-3! max-md:bg-background/50!';
