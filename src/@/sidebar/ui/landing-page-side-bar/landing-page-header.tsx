  ...
  return (
    <div className="flex! flex-col! gap-3!">
      <div className="flex! items-start! justify-between! gap-3!">
        ...
        <div className="-mt-0.5! inline-flex! items-center! [&_.cds--btn--ghost]:bg-transparent! [&_.cds--btn--ghost:active]:bg-transparent! [&_.cds--btn--ghost:focus]:bg-transparent! [&_.cds--btn--ghost:hover]:bg-transparent! [&_.sidebar-worldview-shareIcon_svg]:fill-foreground!">
