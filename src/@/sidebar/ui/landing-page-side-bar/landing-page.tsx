        ...
        <LandingPageContentWrapper>
          ...
          <MappedContentWrapper>
            ...
            {isLoadingGlobalStats ? <LoadingText lineCount={2} paragraph /> :
              <>
                <SchoolNumberWrapper>
                  <p>
                    <span data-title={t('int', { val: globalstats?.schools_connected ?? 0 })}>{formatNumber(globalstats?.schools_connected ?? 0, lng)}</span><span data-title={t('int', { val: 6000000 })}>/6{LanguageSuffixes[lng].million}</span> <span className="text">{t('schools-location-mapped')}</span>
                  </p>
          ...
          <MappedContentWrapper>
            ...
            {isLoadingGlobalStats ? <>
              ...
              <>
                <SchoolNumberWrapper>
                  <p>
                    <span data-title={t('int', { val: globalstats?.schools_with_connectivity_status_mapped })}>{formatNumber(globalstats?.schools_with_connectivity_status_mapped ?? 0, lng)}</span> <span className="text">{t('schools-connectivity-status-mapped')}</span>
                  </p>
          ...
          <MappedContentWrapper>
            ...
            {isLoadingGlobalStats ? <>
              ...
              <SchoolNumberWrapper>
                <p>
                  <span data-title={t('int', { val: connectivityStats?.no_of_schools_measure ?? 0 })}>{formatNumber(connectivityStats?.no_of_schools_measure ? connectivityStats?.no_of_schools_measure : 0, lng)}</span> <span className="text">{t('schools-with-real-time-data-mapped')}</span>
                </p>
