        ...
        <LandingPageContentWrapper>
          ...
          <MappedContentWrapper>
            ...
            {isLoadingGlobalStats ? <>
              ...
              <>
                <SchoolNumberWrapper>
                  <p>
                    <span title={t('int', { val: globalstats?.schools_with_connectivity_status_mapped })}>{formatNumber(globalstats?.schools_with_connectivity_status_mapped ?? 0, lng)}</span> <span className="text">{t('schools-connectivity-status-mapped')}</span>
                  </p>
                ...
                <MappedInfoWrapper>
                  ...
                  <span title={t('int', { val: globalstats?.schools_with_connectivity_status_mapped ?? 0 })}>
          ...
          <MappedContentWrapper>
            ...
            {isLoadingGlobalStats ? <>
              ...
              <SchoolNumberWrapper>
                <p>
                  <span title={t('int', { val: connectivityStats?.no_of_schools_measure ?? 0 })}>{formatNumber(connectivityStats?.no_of_schools_measure ? connectivityStats?.no_of_schools_measure : 0, lng)}</span> <span className="text">{t('schools-with-real-time-data-mapped')}</span>
                </p>
              ...
              <MappedInfoWrapper>
                <p title={t('int', { val: connectivityStats?.countries_with_realtime_data ?? 0 })}>
                  {t('across-no-countries', { count: connectivityStats?.countries_with_realtime_data ?? 0 })}
                </p>
                <span title={t('int', { val: connectivityStats?.no_of_schools_measure ?? 0 })}>
