...
export const mapEntity = router.add('/map/entity:path(/.*)?');
...
export const viewGigaLayer = router.add<{ id: number }>(
  '/admin/giga-layer/view/:id:path(/.*)?',
);
export const editGigaLayer = router.add<{ id: number }>(
  '/admin/giga-layer/edit/:id:path(/.*)?',
);
...
export const editAdminFilter = router.add<{ id: number }>(
  '/admin/filter/edit/:id:path(/.*)?',
);

export const backgroundTask = router.add('/admin/background-task');
export const backgroundTaskView = router.add(
  '/admin/background-task/view/:id:path(/.*)?',
);

export const contactMessage = router.add('/admin/contact-message');
export const contactMessageView = router.add(
  '/admin/contact-message/view/:id:path(/.*)?',
);
...
export const dataSourceEdit = router.add(
  '/admin/data-source/edit/:id:path(/.*)?',
);

export const adminCountry = router.add('/admin/country');
export const addAdminCountry = router.add('/admin/country/country/add');
export const addCountrySummary = router.add(
  '/admin/country/country-summary/add',
);
export const addCountryDailySummary = router.add(
  '/admin/country/country-daily-summary/add',
);
export const editAdminCountry = router.add(
  '/admin/country/country/edit/:id:path(/.*)?',
);
export const editCountrySummary = router.add(
  '/admin/country/country-summary/edit/:id:path(/.*)?',
);
export const editCountryDailySummary = router.add(
  '/admin/country/country-daily-summary/edit/:id:path(/.*)?',
);
...
export const addSchoolDailySummary = router.add(
  '/admin/schools/school-daily-summary/add',
);
export const editAdminSchools = router.add(
  '/admin/schools/school/edit/:id:path(/.*)?',
);
export const editSchoolSummary = router.add(
  '/admin/schools/school-summary/edit/:id:path(/.*)?',
);
export const editSchoolDailySummary = router.add(
  '/admin/schools/school-daily-summary/edit/:id:path(/.*)?',
);
...
export const $mapRoutes = combine({
  ...
  entity: mapEntity.visible,
  entityView: entityView.visible,
});

export const $countryRouteLeave = guard(mapCountry.visible, {
  filter: (value) => !value,
});
export const $mapRouteLeave = guard(mapOverview.visible, {
  filter: (value) => !value,
});
