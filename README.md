...
- **VITE_POSTHOG_KEY**: (optional) PostHog project API key. When unset, PostHog analytics is disabled.
- **VITE_POSTHOG_HOST**: (optional, default: `https://eu.i.posthog.com`) PostHog API host. Use `https://us.i.posthog.com` for US cloud.
